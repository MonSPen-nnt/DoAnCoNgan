...
namespace DoAnCoNgan.Controllers
{
    public class DanhMucsController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "MaDanhMuc,TenDanhMuc,DonViTinh")] DanhMuc danhMuc)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "MaDanhMuc,TenDanhMuc,DonViTinh")] DanhMuc danhMuc)
        {
            if (ModelState.IsValid)
            {
