...
namespace DoAnCoNgan.Controllers
{
    public class CauHinhsController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "IdCauHinh,TenCauHinh,GIATRI")] CauHinh cauHinh)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "IdCauHinh,TenCauHinh,GIATRI")] CauHinh cauHinh)
        {
            if (ModelState.IsValid)
            {
